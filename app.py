...
with tab2:
    ...
    with col_e:
        ...
        if not q8_df.empty:
            fig_q8 = px.bar(
                q8_df, x="service_type", y="service_count", color="guest_type", 
                barmode="group", text="service_count", color_discrete_sequence=["#38bdf8", "#fb7185"],
            ...
            st.info("ไม่พบข้อมูลการใช้บริการ Spa และFood")
